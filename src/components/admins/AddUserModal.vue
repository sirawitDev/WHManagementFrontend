...
const validateForm = () => {
    ...
    } else if (!/^[0-9]{9,10}$/.test(formData.value.phone.replace(/\D/g, ''))) {
...
const handlePhoneInput = (e) => {
    formData.value.phone = formatPhone(e.target.value)
}
                ...
                <div class="modal-header">
                    <div class="header-content">
                        ...
                        <div>
                            ...
                            <p class="modal-subtitle">กรอกข้อมูลสำหรับผู้ใช้ใหม่</p>
                        </div>
                    </div>
                    ...
                    <form @submit.prevent="handleSubmit" class="space-y-4">
                        <div>
                            <div class="form-group">
                                ...
                                <input v-model="formData.username" type="text" class="form-input"
                                    :class="{ 'error': errors.username }" placeholder="username สำหรับเข้าสู่ระบบ"
                                    :disabled="isLoading" />
                                <p v-if="errors.username" class="error-message">{{ errors.username }}</p>
                                <p class="hint-text">ใช้ตัวอักษร ตัวเลข หรือ _ เท่านั้น</p>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input v-model="formData.password" type="password" class="form-input"
                                        :class="{ 'error': errors.password }" placeholder="รหัสผ่านอย่างน้อย 6 ตัวอักษร"
                                        :disabled="isLoading" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="formData.confirmPassword" type="password" class="form-input"
                                        :class="{ 'error': errors.confirmPassword }" placeholder="ยืนยันรหัสผ่าน"
                                        :disabled="isLoading" />
                                    <p v-if="errors.confirmPassword" class="error-message">{{ errors.confirmPassword }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input v-model="formData.firstname" type="text" class="form-input"
                                    :class="{ 'error': errors.firstname }" placeholder="กรอกชื่อ"
                                    :disabled="isLoading" />
                            ...
                            <div class="form-group">
                                ...
                                <input v-model="formData.lastname" type="text" class="form-input"
                                    :class="{ 'error': errors.lastname }" placeholder="กรอกนามสกุล"
                                    :disabled="isLoading" />
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="formData.phone" type="tel" class="form-input"
                                :class="{ 'error': errors.phone }" placeholder="081-234-5678" :disabled="isLoading"
