    ...
    <div class="flex">
        <aside v-if="!isMobile" class="fixed top-0 left-0 h-full w-64 bg-white shadow-lg flex flex-col z-10">
            ...
            <nav class="flex-1 p-4 space-y-2">
                <RouterLink to="/admin" class="block cursor-pointer w-full px-3 py-2 rounded-lg hover:bg-[#DDE0FF] text-[#14158C] font-medium transition-colors border-2 border-[#14158C]">
        ...
        <div v-if="isMobile">
            ...
            <transition name="slide">
                <aside v-if="showAside" class="fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-40 flex flex-col">
                    ...
                    <nav class="flex-1 p-4 space-y-2">
                        <RouterLink to="/admin" class="block px-3 py-2 rounded-lg hover:bg-[#DDE0FF] text-[#14158C] font-medium transition-colors">
                            <span class="flex items-center gap-2">
                                <LayoutDashboard class="w-5 h-5" />
                                Dashboard
                            </span>
