...
export const useGoodIssueStore = defineStore('goodIssue', {
    ...
    actions: {
        ...
        async fetchGoodIssues() {
            this.loading = true
            try {
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/checker/reports/goodissue`)
        ...
        async fetchGoodIssueById(id) {
            this.loading = true
            try {
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/checker/reports/goodissue/${id}`)
        ...
        async createGoodIssue(data) {
            ...
            try {
                const response = await axios.post(
                    `${import.meta.env.VITE_API_URL}/checker/reports/goodissue`,
                    data
                )
        ...
        async deleteGoodIssue(id, code) {
            ...
            this.loading = true
            try {
                await axios.delete(`${import.meta.env.VITE_API_URL}/checker/reports/goodissue/${id}`)
                await this.fetchGoodIssues()
